...
class TT100KDetection(VisionDataset):
    """Pascal VOC detection Dataset.

    Parameters
    ----------
    root : str, default '~/data/TT100K/TT100K_chip_voc'
    ...
    def __init__(self, root=os.path.join('~', 'data', 'TT100K', 'TT100K_chip_voc'),
                 splits='train', transform=None, index_map=None, preload_label=True):
        super(TT100KDetection, self).__init__(root)
        self._im_shapes = {}
